...
def train(model, tensor_loader, num_epochs, learning_rate, criterion, device, test_loader):
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), os.path.join(model_save_pth, f'{args.dataset}_{args.model}.pth'))
    ...
    plt.tight_layout()
    plt.savefig(f'plots/{args.dataset}_{args.model}.png')
